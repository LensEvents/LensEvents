...
public class Group implements Serializable{
    ...
    private Set<FirebaseUser> members;
    ...
    public Group(String name, String description, Set<FirebaseUser> members, Set<FirebaseUser> administrators, String photo, List<String> media, Category category, String accessCode) {
        this.name = name;
        this.description = description;
    ...
    public Set<FirebaseUser> getMembers() {
        return members;
    }

    public void setMembers(Set<FirebaseUser> members) {
        this.members = members;
    }
